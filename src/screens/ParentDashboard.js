...
export default function ParentDashboard({ navigation }) {
  ...
  <View style={styles.quickActions}>
    ...
    >
      ...
      <Text style={styles.quickActionText}>Vincular Filho</Text>
    </TouchableOpacity>
    ...
    <TouchableOpacity 
      ...
      onPress={() => {
        ...
        Alert.alert('Em breve', 'Selecione um filho para iniciar o chat com o professor');
      }}
    >
    ...
    <TouchableOpacity 
      style={styles.quickActionCard}
      onPress={() => Alert.alert('Em breve', 'Histórico será implementado')}
    >
    ...
    <TouchableOpacity 
      style={styles.quickActionCard}
      onPress={() => Alert.alert('Em breve', 'Configurações serão implementadas')}
    >
...
const startChat = async (student) => {
  try {
    ...
    const teacherId = student.enrollments[0]?.classes?.teacher_id;
    ...
    navigation.navigate('Chat', {
      ...
      recipientName: student.enrollments[0]?.classes?.profiles?.name || 'Professor',
...
const styles = StyleSheet.create({
  ...
  quickActionCard: {
    width: '47%', // Mudando de flex: 1 para width percentual
    backgroundColor: 'white',
    padding: theme.spacing.md,
    borderRadius: theme.borderRadius.md,
    alignItems: 'center',
    minHeight: 100, // Altura mínima para todos os cartões
    justifyContent: 'center',
    marginBottom: theme.spacing.md,
    ...theme.shadows.small,
  },
